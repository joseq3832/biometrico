  ...
  @endsection
    ...
    <script type="text/javascript">
        ...
        $('#paralelos').on('change', function(e) { 
            ...
            $.get('/materias/'+{{$ultimoPeriodo}}+'/'+codseccion+'/'+codparalelo, function(data) {
        ...
        function test(){
            ...
            $.get('/asistenciaDeEstudianteRango/'+{{$ultimoPeriodo}}+'/'+codseccion+'/'+codparalelo+'/'+codmateria+'/'+fechaInicio+'/'+fechaFin, function(data) {
                ...
                var body = document.getElementsByTagName("tabledata")[0];
                    ...
                    $('#box-footer').empty();
                    $('#box-footer').append("<br><a href='asistencia_entre_fechas_supervisor_pdf/"+{{$ultimoPeriodo}}+"/"+codseccion+"/"+codparalelo+"/"+codmateria+"/"+fechaInicio+"/"+fechaFin+"'><button type='button' class='btn btn-primary' onclick='ver()'>Imprimir</button></a>");
