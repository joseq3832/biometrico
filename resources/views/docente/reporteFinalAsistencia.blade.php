    ...
    <div class="box box-primary">
        <div class="box-body">
            ...
            <thead>
                ...
                <td><a href="asistenciaDeMateriaDocentepdf/{{$lista->codperiodo}}/{{$lista->codseccion}}/{{$lista->codparalelo}}/{{$lista->codmateria}}"><button type="button" id="pdf" class="btn btn-default btn-bg" onclick="ver()"><span class="glyphicon glyphicon-print"></span></button></a></td>
