...
<head>
  ...
  <title>Control de Asistencia Supervisor</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="{{route('home')}}" class="logo">
        ...
        <span class="logo-lg"><b>Supervisor</b></span>
      </a>
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          ...
          <div class="pull-left info">
            ...
            <!-- Status -->
            <a href=""><i class="fa fa-circle text-success"></i> Supervisor Activo </a>
          </div>
        </div>
        <br><br>
        <!-- Sidebar Menu -->
        <ul class="sidebar-menu" data-widget="tree">
          ...
          @yield('activeInformacion')<a href="{{route('SupervisorInformacion')}}"><i class="fa fa-drivers-license-o"></i> <span>Información Personal</span></a></li>
          ...
          <ul class="treeview-menu">
            ...
            @yield('activeAsistenciaPorFecha')<a href="{{route('AsistenciaFechaDeterminadaSupervisor')}}">Asistencia por día</a></li>
            @yield('activeAsistenciaRangoFechas')<a  href="{{route('AsistenciaEntreFechasSupervisor')}}">Asistencia entre fechas</a></li>
